...
export const PLAYER_MAX_ATTACK = 50;
export const ADD_PLAYER_ATTACK_PER_LEVEL = 20;
...
export const WEREWOLF_LIFE_POINTS = 200;
...
export const VAMPIRE_LIFE_POINTS = 350;
...
export const DRAGON_LIFE_POINTS = 250;
...
export const FERUMBRAS_LIFE_POINTS = 1000;
