...
class Character {
  ...
  useHealthPotion() {
    while (true) {
      ...
      healthPotionsToUse = int(
        input("\t How many Health Potions you want to use: ")
      );
      if (healthPotionsToUse == 0) break;
        ...
        while (healthPotionsToUse !== 0) {
          healthCure = Math.floor(Math.random() * 125) + 75;
    ...
    while (true) {
      ...
      if (manaPotionsToUse == 0) break;
        ...
        while (manaPotionsToUse !== 0) {
          manaCure = Math.floor(Math.random() * 125) + 75;
  ...
  getMonsterExperience(experienceMonster) {
...
const NORMAL_MIN_ATTACK = 20;
const NORMAL_MAX_ATTACK = 100;

const WARRIOR_ADD_HEALTH_PER_LEVEL = 75;
const WARRIOR_ADD_MANA_PER_LEVEL = 75;

const MAGE_ADD_HEALTH_PER_LEVEL = 25;
const MAGE_ADD_MANA_PER_LEVEL = 75;

const ARCHER_ADD_HEALTH_PER_LEVEL = 50;
const ARCHER_ADD_MANA_PER_LEVEL = 50;
...
class GameStatistics {
  static totalGoldCoinsEarned = 0;
  static totalGoldCoinsUsed = 0;
  static totalManaPotionsUsed = 0;
  static healthPotionsUsed = 0;
  static healSpellUsed = 0;
  static totalNormalAttacksUsed = 0;
  static weakSpellUsed = 0;
  static strongSpellUsed = 0;
